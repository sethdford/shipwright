...
| `pre_build_validate`        | `true`  | Enable pre-build environment checks before iter 1 |
| `pre_build_timeout`         | `15`    | Timeout for pre-build checks (seconds)            |
