...
Static templates remain as fallbacks when intelligence is disabled or when a Claude API call fails. See the [Intelligence guide](/guides/intelligence/) for configuration details.
