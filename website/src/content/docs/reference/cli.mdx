...
Machine registry is stored at `~/.claude-teams/machines.json`.
...
Configuration is stored at `~/.claude-teams/tracker-config.json`. See [Issue Tracking guide](/guides/tracking/) for setup instructions.
