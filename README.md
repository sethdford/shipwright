...
<!-- E2E pipeline verification marker — issue #5151, 2026-09-16. Inert HTML comment;
     proves the autonomous pipeline can edit, test, and ship a README change end to end.
     Supersedes the #5148 marker: one marker is kept, not one per run, so repeated E2E
